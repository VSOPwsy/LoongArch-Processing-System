...
//Created Time: 2024-04-04 15:11:04
create_clock -name CLK_OSC -period 20 -waveform {0 10} [get_ports {clk_osc}]
//create_clock -name UI_CLK -period 10 -waveform {0 5} [get_nets {ddr_ctr/ddr_ui_clk}]
...
//create_generated_clock -name CLK_8M -source [get_ports {clk_osc}] -master_clock CLK_OSC -divide_by 13 -multiply_by 2 [get_nets {PLL/clk_8M}]

...
//set_clock_groups -asynchronous -group [get_clocks {tck_pad}] -group [get_clocks {UI_CLK CORE_CLK}]
set_clock_groups -asynchronous -group [get_clocks {CORE_CLK}] -group [get_clocks {MEMORY_CLK UI_CLK}]

...
set_clock_groups -asynchronous -group [get_clocks {CPU_CLK}] -group [get_clocks {JTAG_CLK LJTAG_CLK CLK_50M CORE_CLK MEMORY_CLK UI_CLK SD_INIT_CLK}]
set_clock_groups -asynchronous -group [get_clocks {CORE_CLK}] -group [get_clocks {JTAG_CLK LJTAG_CLK CLK_50M CPU_CLK MEMORY_CLK UI_CLK SD_INIT_CLK}]
